...
class ExpenseConstructor1Test {
    ...
    void constructorTestWithNullName() {
      assertThrows(IllegalArgumentException.class, () -> new Expense(null, 100, 2, LocalDate.now()));
    }

    @Test
    @DisplayName("Test constructor with empty name")
    void constructorTestWithEmptyName() {
      assertThrows(IllegalArgumentException.class, () -> new Expense("", 100, 2, LocalDate.now()));
    }
...
class ExpenseConstructor2Test {
    ...
    @DisplayName("Test constructor with null name")
    void constructorTestWithNullName() {
      assertThrows(IllegalArgumentException.class, () -> new Expense(null, 100.00, LocalDate.now(),"Food", "Cash"));
    }

    @Test
    @DisplayName("Test constructor with empty name")
    void constructorTestWithEmptyName() {
      assertThrows(IllegalArgumentException.class, () -> new Expense("", 100.00, LocalDate.now(),"Food", "Cash"));
    }
...
class ExpenseConstructor3Test {
  ...
  @DisplayName("Test constructor with null name")
  void constructorTestWithNullName() {
    assertThrows(IllegalArgumentException.class, () -> new Expense(null, 100.00, LocalDate.now(), "Food", "Cash", "123"));
  }

  @Test
  @DisplayName("Test constructor with empty name")
  void constructorTestWithEmptyName() {
    assertThrows(IllegalArgumentException.class, () -> new Expense("", 100.00, LocalDate.now(), "Food", "Cash", "123"));
  }
...
class ExpenseSettersTest{
    ...
    void setNameTestWithNull() {
      Expense expense = new Expense("ExpenseName", 100, 2, LocalDate.now());
      assertThrows(IllegalArgumentException.class, () -> expense.setName(null));
    }
    ...
    void setCategoryIntTestWithInvalidValue() {
      Expense expense = new Expense("ExpenseName", 100, 2, LocalDate.now());
      assertThrows(IllegalArgumentException.class, () -> expense.setCategoryInt(6));
    }
    @Test
    ...
    void setCategoryAsStringTestWithBlankValue() {
      Expense expense = new Expense("ExpenseName", 100, 2, LocalDate.now());
      assertThrows(IllegalArgumentException.class, () -> expense.setCategoryAsString(null));
    }
